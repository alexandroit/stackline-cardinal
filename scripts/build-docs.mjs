...
await cp(new URL('assets/screen-shot.png', root), new URL('assets/cardinal-terminal.png', output))
await cp(new URL('dist/cardinal.global.js', root), new URL('package.js', output))
